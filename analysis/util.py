...
class FLOPs:
    ...
    def register_supported_ops():
        from basicsr.vmamba.models.csms6s import selective_scan_flop_jit
        # selective_scan_flop_jit: Callable = build.csms6s.selective_scan_flop_jit
        ...
        supported_ops={
            ...
            # "prim::PythonOp.CrossScanTritonF": None, # # as the operation is all about transpose and flip
            # "prim::PythonOp.CrossMergeTritonF": None, # # as the operation is all about transpose and flip
