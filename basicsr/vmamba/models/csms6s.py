...
try:
    ...
    warnings.warn("Cannot import selective_scan_cuda_oflex. This affects speed.")
    print("Can not import selective_scan_cuda_oflex. This affects speed.", flush=True)
# try:
#     import selective_scan_cuda_core
# except ImportError:
#     WITH_SELECTIVESCAN_CORE = False
#     warnings.warn("Cannot import selective_scan_cuda_core. This affects speed.")
#     print("Cannot import selective_scan_cuda_core. This affects speed.", flush=True)
try:
    import selective_scan_cuda
except ImportError:
    WITH_SELECTIVESCAN_MAMBA = False
    warnings.warn("Cannot import selective_scan_cuda. This affects speed.")
    print("Cannot import selective_scan_cuda. This affects speed.", flush=True)
