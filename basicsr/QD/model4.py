...
class ReflectionConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, groups=1):
        ...
        self.norm = nn.GroupNorm(1, out_channels)  # Simple GN, can adjust groups
...
class SmoothBlock(nn.Module):
    def __init__(self, channels, kernel_size=3):
        ...
        # A small stack of convolutions to low-pass filter Q2
        # Using depthwise convs to simulate a smoothing filter
...
class Decomp(nn.Module):
    def __init__(self,
        ...
        # Post-processing smoothing modules for Q1 and Q2
        # Each Q1/Q2 has 4 channels (Q1r, Q1i, Q1j, Q1k), same for Q2
        # We'll apply smoothing after reconstruction, before return
